...
st.markdown('''**시간적 배경**
            시대: 고대 이집트, 고대 그리스. 고대 로마, 중세유럽, 르네상스 시대, 조선시대.대항해 시대, 근대, 제1차 세계대전 제2 차 세계대전, 현대, 미래, 가상 현실
...
st.markdown('''**공간적 배경**
            범위: 우주, 행성, 국가, 도시, 마을  
            환경: 우주, 산, 해안, 심해, 하늘, 도시, 지하, 사막, 숲, 극지방, 고대 유적지, 판타지세계
            ''')
background_place = st.text_input("공간적 배경을 입력하세요.: ")
st.markdown('''**사회적 환경**
            독재, 민주주의, 공산주의, 계몽주의, 제국주의, 전쟁, 자본주의, 공동체주의, 유토피아, 디스토피아, 반과학주의, 종교, 환경, 아포칼립스(화생방, 지구멸망, 좀비...), 인류멸망
            ''')
